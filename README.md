...
Generate the build for the website:

```bash
yarn build
```

Locally host the build for the website:
...
Use [@next/bundle-analyzer](https://www.npmjs.com/package/@next/bundle-analyzer) to analyze bundle sizes:
